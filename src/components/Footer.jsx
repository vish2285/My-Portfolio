    ...
    <div id= "Contact" className="flex-row justify-evenly text-center align-center gap-16">
      <div>
        ...
        <div className=" flex flex-row justify-evenly align-middle items-center pr-2 pt-3.5">
          <a href="https://www.linkedin.com/in/vishwas-patel-7462aa299/"><img className=" size-10 md:size-16" alt="LinkedIn" src="./img/linkedin.jpeg"></img></a>
          <a href="https://github.com/vish2285"><img className=" size-10 md:size-16" alt="github" src="./img/github.jpeg"></img></a>
          <a href="https://discord.com/users/787798291961610260"><img className=" size-10 md:size-16" alt="Discord" src="./img/discord.jpeg"></img></a>
        </div>
      </div>
